...
const Button = ({
  ...
  return (
    <View className={`button button-type-${nextType} button-size-${nextSize} ${danger ? 'button-danger' : ''} ${fluid ? 'button-fluid' : ''} ${disabled ? 'button-disabled' : ''} ${loading ? 'button-loading' : ''}`}
